...
# ACDS 22.1 915 win32 2022.11.20.21:28:55
# ----------------------------------------
...
# ----------------------------------------
# If DivisorFrec is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "DivisorFrec"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "D:/programas/quartus/quartus/"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/DivisorFrec.vo"
}
